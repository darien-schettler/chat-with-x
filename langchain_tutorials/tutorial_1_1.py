...
def generate_text(input_text, model_name='text-davinci-003', n=1, temperature=0.7):
    ...
    llm = OpenAI(model_name=model_name, n=n, temperature=temperature)
...
def main():
    ...
    parser.add_argument("--model_name", type=str, default="text-davinci-003", help="Model name for the LLM")
    parser.add_argument("--n", type=int, default=1, help="Number of responses")
    parser.add_argument("--temperature", type=float, default=0.7, help="Temperature for randomness in output")
    ...
    generate_text(args.input_text, args.model_name, args.n, args.temperature)
